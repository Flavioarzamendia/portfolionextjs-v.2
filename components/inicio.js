    ...
    <>
      <div className="bg-white font-sans leading-normal tracking-normal mx-auto">
        <header className="bg-white text-gray-700 py-12 lg:py-20">
          <motion.div className="container mx-auto px-4 md:px-20">
            <div className="grid grid-cols-1 lg:grid-cols-2  items-center justify-between gap-8 py-20">
              ...
              >
                <h1
                  className="text-6xl text-[#2B7CB3] text-center uppercase  md:text-left md:text-5xl lg:text-7xl font-bold leading-tight 
              mb-14 font-sans mt-0"
                >
                  Flavio Arzamendia{" "}
                  <span className="block text-5xl normal-case text-gray-900 mt-4 font-semibold">
                    Desarrollador Web Freelance en Buenos Aires.
                  </span>
                </h1>
                <p className="text-2xl leading-10 md:text-3xl md:text-left md:p-0 mb-5   font-sans font-normal  px-10">
                <strong>Soy especialista en diseño y desarrollo web</strong> para <strong>Argentina y Latinoamérica</strong>.
                </p>

                <p className="text-2xl leading-10 md:text-3xl md:text-left md:p-0 mb-5   font-sans font-normal  px-10">
                Ofrezco <strong>soluciones personalizadas</strong> y optimizadas para <strong>SEO</strong> utilizando tecnologías como <strong>Next.js, WordPress, Shopify, Tienda Nube</strong>, entre otras.
                </p>

                <p className="text-2xl leading-10 md:text-3xl md:text-left md:p-0 mb-20   font-sans font-normal  px-10">
                Colaboro con <strong>PYMES</strong> y profesionales de sectores como <strong>educación, turismo</strong>, y más.
                </p>
              ...
              <div className="flex-1 sm:float-none md:mt-14 mb-0">
                <Image
                  loading="eager"
                  src="/img/hero.jpg"
          ...
          <div className="container mx-auto px-4 md:px-8 ">
            <div className="flex flex-col lg:flex-row items-center justify-between">
              ...
              <div className="flex-1 p-4 mx-10 text-center md:text-left">
                <h2 className="text-3xl md:text-5xl  text-center md:text-left  lg:text-5xl font-bold mb-14 uppercase">
                  Sobre mí
                </h2>
                <p className="text-2xl md:text-3xl text-left text-gray-200 mb-14 leading-10">
                  <strong>
                    ¡Hola! Soy Flavio Arzamendia, Desarrollador Web Freelance en
                    Argentina.{" "}
                  </strong>
                  Con sede en Buenos Aires, mi experiencia abarca el{" "}
                  <strong>
                    diseño y desarrollo de sitios web personalizados {" "}
                  </strong>
                  para satisfacer las necesidades específicas de{" "}
                  <strong>empresas y emprendedores</strong> en{" "}
        ...
        <section className="bg-white  py-12 md:py-20">
          <div className="container mx-auto px-4 md:px-8">
            <h2 className="text-3xl md:text-5xl  font-bold text-center mb-8  text-gray-900 uppercase">
              Impulsando tu Presencia Online
            </h2>
            <h3 className="text-xl md:text-2xl  font-semibold  text-center mb-10 md:mb-4 px-10 ">
              Creamos soluciones web a medida para que tu marca se destaque y
              obtenga resultados excepcionales.
            </h3>
            <p className=" mb-20 text-center text-xl md:text-2xl leading-10">
              Nuestros servicios incluyen desarrollo web, diseño responsivo, SEO
              avanzado y marketing digital, todo diseñado para mejorar tu
              visibilidad en línea y atraer más clientes.
            </p>
        ...
        <section className="bg-[#2C3E50] text-white py-20 md:py-20 ">
          <div className="container mx-auto px-4 md:px-8">
            <h2 className="text-3xl md:text-5xl  font-bold text-center mb-8 uppercase">
              Proyectos Destacados de Diseño Web Profesional
            </h2>
            <h3 className="text-xl md:text-2xl  font-semibold  text-center mb-10 md:mb-4 px-10 ">
              Explora nuestra experiencia en el diseño y desarrollo de sitios
              web efectivos y profesionales.
            </h3>
            <p className=" mb-20 text-center text-xl md:text-2xl leading-10">
              Con un enfoque en el diseño y desarrollo web responsivo,
              optimización SEO, nuestros proyectos ayudan a los negocios y
              profesionales a destacar y alcanzar sus objetivos.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14">
              <div className="bg-white rounded-md shadow-lg overflow-hidden md:col-span-2 lg:col-span-1">
                ...
                <div className="p-6 px-10 mt-8">
                  <h3 className="text-3xl lg:text-4xl font-bold mb-6 text-gray-900 uppercase ">
                    Podcast fm
                  </h3>
                  <p className="text-gray-600 mb-6 leading-10 text-2xl font-semibold">
                    Presentación atractiva de la plataforma de podcasts,
                    resaltando su variedad de programas, y potencial de negocio
                    facilidad de uso y opciones de suscripción.
                  </p>
                  <Link
              ...
              <div className="bg-white rounded-md shadow-lg overflow-hidden">
                ...
                <div className="p-6 px-10 mt-8">
                  ...
                  <p className="text-gray-600 mb-6 leading-10 text-2xl font-semibold">
                    Una herramienta intuitiva para gestionar tus finanzas
                    personales, categoriza gastos y visualiza tu presupuesto
                    mensual con facilidad.
                  </p>
                  <Link
                    className=" uppercase inline-flex my-10 items-center justify-center w-full px-4 py-2 bg-blue-600 
                  text-white font-bold rounded-md hover:bg-blue-700  transition ease-in-out    duration-300"
              ...
              <div className="bg-white  rounded-md shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6 px-10 mt-8">
                  <h3 className="text-3xl lg:text-4xl text-gray-900 font-bold mb-6 uppercase">
                    Web Estilo Airbnb
                  </h3>
                  <p className="text-gray-600 mb-6 leading-10 text-2xl font-semibold">
                    Presentación visual de la plataforma de alquiler de
                    propiedades, destacando sus características únicas, como
                    búsqueda intuitiva.
                  </p>
                  <Link
                    className=" uppercase inline-flex my-10 items-center justify-center w-full px-4 py-2 bg-blue-600
        ...
        <section className="bg-white  py-20 md:pt-20 m">
          <div className="container mx-auto px-4 md:px-8">
            <h2 className="text-3xl md:text-5xl  font-bold text-center mb-8  uppercase text-gray-900">
              Descubre Nuestros Planes de Diseño Web
            </h2>
            <h3 className="text-xl md:text-2xl  font-semibold  text-center mb-10 md:mb-4 px-10 ">
              Explora nuestras opciones y contáctanos para obtener un
              presupuesto a tu medida.
            </h3>
            <p className=" mb-20 text-center text-xl md:text-2xl leading-10  md:max-w-[70%] mx-auto">
              Ofrecemos paquetes personalizados que incluyen diseño y desarrollo
              web responsivo, optimización SEO, mantenimiento de sitios web y

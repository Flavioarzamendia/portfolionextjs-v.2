  ...
  return (
    <footer className=" m-0 block text-center  mx-auto left-0 right-0 bottom-0 bg-[#141414]  py-5 footer  z-10 border-t-2  border-[#33353F]">
      ...
      <Link
        ...
        <div className="text-[#726F6F] font-sans md:text-3xl  md:text-start md:flex md:gap-8 md:pl-28 lg:pl-24 ">
        ...
        <div className="text-[#726F6F] font-sans md:text-3xl py-5 md:text-start pr-20 ">
          <Link 
